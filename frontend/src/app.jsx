...
function App() {
  ...
  return (
    ...
    {[
      ...
      <div key={i} className="bg-gray-950 rounded-lg p-6 border border-gray-800 card-glow text-center">
      <div className="text-3xl mb-2">{bench.icon}</div>
      <div className="text-2xl font-bold text-gray-200">{bench.value}</div>
      <div className="text-sm text-gray-500 mt-1">{bench.label}</div>
      </div>
    ))}
    </div>
    </div>
